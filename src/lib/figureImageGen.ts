...
풀어 쓴 흔적은 지웁니다:
- 연필·볼펜·형광펜으로 쓴 손글씨, 밑줄, 동그라미, 별표, 화살표, 지운 자국, 채점
  표시(동그라미·빗금·체크)는 전부 지우고 인쇄된 원래 그림만 남기세요.
- 단, **인쇄된** 밑줄·굵은 글씨·강조 표시는 그림의 일부이니 그대로 두세요.
  손으로 그은 것(삐뚤고 색이 다름)과 인쇄된 것(반듯하고 검정)을 구분하세요.
- 종이 접힌 자국, 얼룩, 그림자, 스캔 줄무늬, 기울어짐도 없애고 똑바로 펴 주세요.
...
풀어 쓴 흔적은 지웁니다:
- 연필·볼펜·형광펜으로 쓴 손글씨, 밑줄, 동그라미, 별표, 화살표, 지운 자국,
  풀이 과정 낙서, 채점 표시(동그라미·빗금·체크)는 전부 지우세요. 인쇄된 원래
  내용만 남깁니다.
- 단, **인쇄된** 밑줄·굵은 글씨·강조는 문제의 일부입니다(밑줄 친 낱말을 묻는
  문제가 많습니다). 반드시 그대로 두세요. 손으로 그은 것(삐뚤고 색이 다르고
  글자를 덮음)과 인쇄된 것(반듯하고 검정)을 구분하세요.
